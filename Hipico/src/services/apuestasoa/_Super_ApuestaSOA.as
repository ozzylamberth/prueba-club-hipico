...
internal class _Super_ApuestaSOA extends com.adobe.fiber.services.wrapper.WebServiceWrapper
{
    ...
    protected function preInitializeService():void
    {
        ...
        wsdl = "http://localhost:8080/ClubHipico/services/ApuestaSOA?wsdl";
    ...
    /**
      ...
      */
    public function add(ap_monto:int, ap_tipo:String, ca_id_caballo:String, co_id_carrera:String) : mx.rpc.AsyncToken
    {
        model_internal::loadWSDLIfNecessary();
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("add");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(ap_monto,ap_tipo,ca_id_caballo,co_id_carrera) ;
