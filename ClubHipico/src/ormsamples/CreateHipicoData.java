...
public class CreateHipicoData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : hip_caballos_hip_corrida, ca_edad, ca_sexo, ca_nombre
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : hip_caja, hip_caballos_hip_corrida, co_hora, co_fecha
			...
			orm.Hip_caballos_hip_corrida lormHip_caballos_hip_corrida = lormHip_caballos_hip_corridaDAO.createHip_caballos_hip_corrida();
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : hip_apuesta
			lormHip_caballos_hip_corridaDAO.save(lormHip_caballos_hip_corrida);
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : ca_id_caballo, ap_tipo, ap_monto
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : co_id_carrera, ganancia
