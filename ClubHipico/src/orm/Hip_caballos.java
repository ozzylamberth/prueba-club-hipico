...
public class Hip_caballos implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		if (key == orm.ORMConstants.KEY_HIP_CABALLOS_HIP_CABALLOS_HIP_CORRIDA) {
	...
	public final orm.Hip_caballos_hip_corridaSetCollection hip_caballos_hip_corrida = new orm.Hip_caballos_hip_corridaSetCollection(this, _ormAdapter, orm.ORMConstants.KEY_HIP_CABALLOS_HIP_CABALLOS_HIP_CORRIDA, orm.ORMConstants.KEY_HIP_CABALLOS_HIP_CORRIDA_CA_ID_CABALLO, orm.ORMConstants.KEY_MUL_ONE_TO_MANY);
